#new_spy file
"""
using the code form professor to download new spy file 
in case to update information to 2016-2020
"""
...
here = os.path.abspath(r'C:\Users\yanqi\OneDrive\Desktop\SPY.csv')
